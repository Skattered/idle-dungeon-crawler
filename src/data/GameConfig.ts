...
export const dpsClasses = {
  warrior: {
    ...
    icon: Sword,
    baseStats: { hp: 75, attack: 18, defense: 12 }, // Reduced from 35 to balance early combat
  ...
  rogue: {
    ...
    icon: Target,
    baseStats: { hp: 65, attack: 12, defense: 8 }, // Reduced from 25 to balance early combat
  ...
  mage: {
    ...
    icon: Flame,
    baseStats: { hp: 60, attack: 20, defense: 6 }, // Reduced from 40 to balance early combat
