...
describe('SaveSystem', () => {
  ...
  describe('manual save', () => {
    test('should not save in development mode', () => {
      // Manual save should be disabled in development
      ...
      // Should be null since manual save is disabled in dev
      expect(fromLocalStorage).toBeNull();
      expect(fromCookies).toBeNull();
    });
  });
