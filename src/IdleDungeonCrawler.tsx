...
const IdleDungeonCrawler = () => {
  ...
  // Temporary no-op functions to prevent errors
  // const processSkills = () => {}; // ENABLED ABOVE
  // const upgradeGear = () => {}; // ENABLED ABOVE
  // const resetToFloorOne = () => {}; // ENABLED ABOVE
  // const advanceProgression = () => {}; // ENABLED ABOVE
